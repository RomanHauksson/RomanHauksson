...
- [🔬 Academic project page template](https://github.com/RomanHauksson/academic-project-astro-template) - A template for a simple project page for your research paper, built using Astro and Tailwind CSS
